...
INSERT INTO usuarios (nome, cpf, email, senha_hash, perfil, status, created_at) VALUES
('Enfº Coord. Carlos Mendes', '12345678901', 'carlos.mendes@wecare.com', '$2b$12$LQv3c1yqBWVHxkd0LHAkCOYz6TtxMQJqhN8/LewBQJhixbNDUFFCG', 'Supervisor', 'Ativo', NOW()),
('Enfª Coord. Ana Paula Silva', '23456789012', 'ana.silva@wecare.com', '$2b$12$LQv3c1yqBWVHxkd0LHAkCOYz6TtxMQJqhN8/LewBQJhixbNDUFFCG', 'Supervisor', 'Ativo', NOW()),
('Enfº Coord. Roberto Santos', '34567890123', 'roberto.santos@wecare.com', '$2b$12$LQv3c1yqBWVHxkd0LHAkCOYz6TtxMQJqhN8/LewBQJhixbNDUFFCG', 'Supervisor', 'Ativo', NOW());

-- ENFERMEIROS SÓCIOS
INSERT INTO usuarios (nome, cpf, email, senha_hash, perfil, status, created_at) VALUES
('Enfª Maria Silva', '45678901234', 'maria.silva@wecare.com', '$2b$12$LQv3c1yqBWVHxkd0LHAkCOYz6TtxMQJqhN8/LewBQJhixbNDUFFCG', 'Socio', 'Ativo', NOW()),
('Enfº João Santos', '56789012345', 'joao.santos@wecare.com', '$2b$12$LQv3c1yqBWVHxkd0LHAkCOYz6TtxMQJqhN8/LewBQJhixbNDUFFCG', 'Socio', 'Ativo', NOW()),
('Enfª Ana Costa', '67890123456', 'ana.costa@wecare.com', '$2b$12$LQv3c1yqBWVHxkd0LHAkCOYz6TtxMQJqhN8/LewBQJhixbNDUFFCG', 'Socio', 'Ativo', NOW()),
('Enfº Carlos Lima', '78901234567', 'carlos.lima@wecare.com', '$2b$12$LQv3c1yqBWVHxkd0LHAkCOYz6TtxMQJqhN8/LewBQJhixbNDUFFCG', 'Socio', 'Ativo', NOW()),
('Enfª Fernanda Rocha', '89012345678', 'fernanda.rocha@wecare.com', '$2b$12$LQv3c1yqBWVHxkd0LHAkCOYz6TtxMQJqhN8/LewBQJhixbNDUFFCG', 'Socio', 'Ativo', NOW()),
('Enfº Roberto Mendes', '90123456789', 'roberto.mendes@wecare.com', '$2b$12$LQv3c1yqBWVHxkd0LHAkCOYz6TtxMQJqhN8/LewBQJhixbNDUFFCG', 'Socio', 'Ativo', NOW()),
('Enfª Patricia Gomes', '01234567890', 'patricia.gomes@wecare.com', '$2b$12$LQv3c1yqBWVHxkd0LHAkCOYz6TtxMQJqhN8/LewBQJhixbNDUFFCG', 'Socio', 'Ativo', NOW()),
('Enfº Lucas Oliveira', '11234567890', 'lucas.oliveira@wecare.com', '$2b$12$LQv3c1yqBWVHxkd0LHAkCOYz6TtxMQJqhN8/LewBQJhixbNDUFFCG', 'Socio', 'Ativo', NOW()),
('Enfª Juliana Ferreira', '21234567890', 'juliana.ferreira@wecare.com', '$2b$12$LQv3c1yqBWVHxkd0LHAkCOYz6TtxMQJqhN8/LewBQJhixbNDUFFCG', 'Socio', 'Ativo', NOW()),
('Enfº Rafael Almeida', '31234567890', 'rafael.almeida@wecare.com', '$2b$12$LQv3c1yqBWVHxkd0LHAkCOYz6TtxMQJqhN8/LewBQJhixbNDUFFCG', 'Socio', 'Ativo', NOW()),
('Enfª Camila Dias', '41234567890', 'camila.dias@wecare.com', '$2b$12$LQv3c1yqBWVHxkd0LHAkCOYz6TtxMQJqhN8/LewBQJhixbNDUFFCG', 'Socio', 'Ativo', NOW()),
('Enfº Bruno Martins', '51234567890', 'bruno.martins@wecare.com', '$2b$12$LQv3c1yqBWVHxkd0LHAkCOYz6TtxMQJqhN8/LewBQJhixbNDUFFCG', 'Socio', 'Ativo', NOW());
...
-- Hospital das Clínicas (id: 4)
(4, 5, TRUE, NOW()),  -- Enfª Maria Silva (trabalha em 2 locais)
(4, 7, TRUE, NOW()),  -- Enfª Ana Costa (trabalha em 2 locais)
(4, 12, TRUE, NOW()), -- Enfº Lucas Oliveira (trabalha em 2 locais)

-- Hospital Albert Einstein (id: 5)
(5, 9, TRUE, NOW()),  -- Enfª Fernanda Rocha (trabalha em 2 locais)
(5, 11, TRUE, NOW()), -- Enfª Patricia Gomes (trabalha em 2 locais)
(5, 14, TRUE, NOW()); -- Enfº Rafael Almeida (trabalha em 2 locais)
...
INSERT INTO escalas (data_inicio, data_fim, hora_inicio, hora_fim, usuario_id, estabelecimento_id, setor, status, created_at) VALUES

-- HOJE - Plantões diurnos e noturnos
(CURDATE(), CURDATE(), '07:00', '19:00', 5, 1, NULL, 'Confirmado', NOW()),
(CURDATE(), CURDATE(), '07:00', '19:00', 8, 1, NULL, 'Confirmado', NOW()),
(CURDATE(), CURDATE(), '07:00', '19:00', 9, 1, NULL, 'Confirmado', NOW()),
(CURDATE(), CURDATE(), '12:00', '18:00', 10, 1, NULL, 'Confirmado', NOW()),
(CURDATE(), DATE_ADD(CURDATE(), INTERVAL 1 DAY), '19:00', '07:00', 6, 1, NULL, 'Confirmado', NOW()),

-- Outros estabelecimentos - HOJE
(CURDATE(), CURDATE(), '08:00', '20:00', 7, 2, NULL, 'Pendente', NOW()),
(CURDATE(), CURDATE(), '14:00', '22:00', 11, 2, NULL, 'Pendente', NOW()),
(CURDATE(), CURDATE(), '06:00', '18:00', 14, 3, NULL, 'Confirmado', NOW()),

-- AMANHÃ - Plantões 24h e normais
(DATE_ADD(CURDATE(), INTERVAL 1 DAY), DATE_ADD(CURDATE(), INTERVAL 2 DAY), '08:00', '08:00', 7, 2, NULL, 'Pendente', NOW()),
(DATE_ADD(CURDATE(), INTERVAL 1 DAY), DATE_ADD(CURDATE(), INTERVAL 1 DAY), '07:00', '19:00', 12, 4, NULL, 'Confirmado', NOW()),
(DATE_ADD(CURDATE(), INTERVAL 1 DAY), DATE_ADD(CURDATE(), INTERVAL 1 DAY), '08:00', '16:00', 15, 3, NULL, 'Confirmado', NOW()),

-- SEMANA ATUAL - Diversos plantões
(DATE_ADD(CURDATE(), INTERVAL 2 DAY), DATE_ADD(CURDATE(), INTERVAL 2 DAY), '07:00', '19:00', 13, 2, NULL, 'Pendente', NOW()),
(DATE_ADD(CURDATE(), INTERVAL 2 DAY), DATE_ADD(CURDATE(), INTERVAL 3 DAY), '19:00', '07:00', 16, 3, NULL, 'Confirmado', NOW()),
(DATE_ADD(CURDATE(), INTERVAL 3 DAY), DATE_ADD(CURDATE(), INTERVAL 3 DAY), '12:00', '20:00', 9, 5, NULL, 'Confirmado', NOW()),
(DATE_ADD(CURDATE(), INTERVAL 4 DAY), DATE_ADD(CURDATE(), INTERVAL 4 DAY), '06:00', '14:00', 11, 5, NULL, 'Pendente', NOW()),

-- PRÓXIMA SEMANA
(DATE_ADD(CURDATE(), INTERVAL 7 DAY), DATE_ADD(CURDATE(), INTERVAL 7 DAY), '07:00', '19:00', 5, 1, NULL, 'Pendente', NOW()),
(DATE_ADD(CURDATE(), INTERVAL 8 DAY), DATE_ADD(CURDATE(), INTERVAL 8 DAY), '08:00', '16:00', 8, 1, NULL, 'Pendente', NOW()),
(DATE_ADD(CURDATE(), INTERVAL 9 DAY), DATE_ADD(CURDATE(), INTERVAL 10 DAY), '19:00', '07:00', 6, 1, NULL, 'Pendente', NOW()),
(DATE_ADD(CURDATE(), INTERVAL 10 DAY), DATE_ADD(CURDATE(), INTERVAL 10 DAY), '14:00', '22:00', 7, 2, NULL, 'Pendente', NOW());
...
-- Supervisor Carlos Mendes (id: 2) supervisiona escalas 1-5
(1, 2, NOW()),
(2, 2, NOW()),
(3, 2, NOW()),
(4, 2, NOW()),
...
-- Supervisor Ana Paula Silva (id: 3) supervisiona escalas 6-10
(6, 3, NOW()),
(7, 3, NOW()),
(8, 3, NOW()),
(9, 3, NOW()),
...
-- Supervisor Roberto Santos (id: 4) supervisiona escalas 11-15
(11, 4, NOW()),
(12, 4, NOW()),
(13, 4, NOW()),
(14, 4, NOW()),
...
-- Check-in fora de local (GPS distante)
...
-- ==========================================
-- 8. DOCUMENTOS (Exemplos)
-- ==========================================

INSERT INTO documentos (usuario_id, nome_arquivo, tipo_documento, arquivo_path, tamanho_bytes, mimetype, processado, created_at) VALUES
(5, 'coren_maria_silva.pdf', 'COREN', '/uploads/documents/coren_maria_silva.pdf', 256000, 'application/pdf', TRUE, NOW()),
(5, 'certificado_especializacao_maria.pdf', 'Certificado', '/uploads/documents/certificado_especializacao_maria.pdf', 512000, 'application/pdf', FALSE, NOW()),
(6, 'rg_joao_santos.jpg', 'RG', '/uploads/documents/rg_joao_santos.jpg', 128000, 'image/jpeg', TRUE, NOW()),
(7, 'diploma_enfermagem_ana_costa.pdf', 'Diploma', '/uploads/documents/diploma_enfermagem_ana_costa.pdf', 1024000, 'application/pdf', TRUE, NOW()),
(8, 'coren_carlos_lima.pdf', 'COREN', '/uploads/documents/coren_carlos_lima.pdf', 345000, 'application/pdf', FALSE, NOW()),
(9, 'certificado_uti_fernanda_rocha.pdf', 'Certificado', '/uploads/documents/certificado_uti_fernanda_rocha.pdf', 678000, 'application/pdf', TRUE, NOW());

-- ==========================================
-- 9. LOGS DE SISTEMA (Atividades recentes)
-- ==========================================
...
-- ==========================================
-- 10. TRANSFERÊNCIAS DE PLANTÃO (Exemplos)
-- ==========================================
...
UNION ALL
SELECT 'TRANSFERENCIAS', COUNT(*) FROM transferencias_plantao;

-- Mostrar usuários por perfil
SELECT perfil, COUNT(*) as quantidade 
FROM usuarios 
GROUP BY perfil 
ORDER BY quantidade DESC;

-- Mostrar escalas por status
...
-- ==========================================
-- SCRIPT FINALIZADO - FOCO EM ENFERMEIROS
-- ========================================== 